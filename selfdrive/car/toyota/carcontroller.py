...
class CarController:
  ...
  def update(self, CC, CS, now_nanos):
    ...
    if self.CP.enableGasInterceptor and CC.longActive:
      ...
      elif self.CP.carFingerprint in (CAR.COROLLA, CAR.COROLLAH_TSS2):
        PEDAL_SCALE = interp(CS.out.vEgo, [0.0, MIN_ACC_SPEED, MIN_ACC_SPEED + PEDAL_TRANSITION], [0.25, 0.35, 0.0])
      else:
