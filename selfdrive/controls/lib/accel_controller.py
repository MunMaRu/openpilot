...
_DP_CRUISE_MIN_V_ECO =   [-0.480, -0.480,  -0.50, -0.50, -0.50, -0.45]
...
_DP_CRUISE_MAX_V =       [3.4, 2.8, 1.8, 1.4, .92,  0.76, .54,  .42, .32, .13]
_DP_CRUISE_MAX_V_ECO =   [2.5, 2.0, 1.2, 0.9, .68,  .56,  .45,  .33, .24, .09]
...
#_DP_CRUISE_MAX_V_ECO =   [2.5, 1.7, 0.8, 0.6, .65,  .55, .45,  .35, .25, .08]
